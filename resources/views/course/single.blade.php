            ...
            <div class="flex mt-8">
                ...
                <div class="mt-2 w-2/3 border-gray-100 border-r pr-10 pb-0 border-b-0">
                    ...
                    <div class="rounded-sm mt-8 shadow-sm bg-white">
                        <img class="sm:w-full h-56" src="{{$course->image}}"  alt="{{$course->name}}">
                        <div class="p-6">
                        ...
                        <div class="space-y-4 p-6">
                            ...
                            <div class="space-y-4 pb-2">
                                <div class="aspect-w-3 aspect-h-2">
                                    <img class="object-cover w-48 m-auto shadow" src="{{$author->image}}" alt="Freek Van der Herten Profile Picture">
                                </div>
