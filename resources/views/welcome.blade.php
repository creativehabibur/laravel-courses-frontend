    ...
    <div class="container">
        <ul class="flex items-center flex-nowrap justify-between gap-y-7 gap-3">
            ...
            <li class="w-full lg:max-w-[165px]">
                <a href="https://laravel_courses.test/series/{{ $item->slug }}" class="bg-white border mx-auto border-orange box-shadow w-full h-12 md:h-16 rounded-lg flex items-center justify-center">
