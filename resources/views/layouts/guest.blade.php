                ...
                <div class="flex h-16 justify-between items-center">
                    ...
                    <div class="flex items-center">
                        @if(Auth::check())
                            ...
                            @if(Auth::user()->type === 1)
                                <a href="{{route('dashboard')}}" class="ml-4 inline-flex items-center justify-center rounded border border-transparent bg-black px-4 py-2 text-sm font-medium text-white shadow-sm hover:bg-red-500"> Dashboard</a>
                            @else
                                <a href="#" class="ml-4 inline-flex items-center justify-center rounded border border-transparent bg-black px-4 py-2 text-sm font-medium text-white shadow-sm hover:bg-red-500">Submitted Course</a>
                            @endif

                            <form method="post" action="{{route('logout')}}" class="ml-4">@csrf
            ...
            <div class="container flex justify-between pb-[50px]">
                <div>
                    ...
                    <ul class="mt-5">
                        ...
                        <li class="mb-2">
                            <a href="{{route('archive',['series','vuejs'])}}" class="text-links text-gray-100 text-base before:text-gray-100">Vue.js</a>
                        </li>
                    </ul>
                </div>
                <div>
                ...
                <div>
                    ...
                    <ul class="mt-5">
                        ...
                        <li class="mb-2">
                            <a href="{{route('archive',['platform','larajobs'])}}" class="text-links text-gray-100 text-base before:text-gray-100">Larajobs</a>
                        </li>
                        <li class="mb-2">
                            <a href="{{route('archive',['platform','laravel_forum'])}}" class="text-links text-gray-100 text-base before:text-gray-100">Laravel Forum</a>
                        </li>
                    </ul>
                </div>
                <div>
